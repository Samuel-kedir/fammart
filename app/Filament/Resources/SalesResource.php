...
class SalesResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Grid::make(1)->schema([
                TableRepeater::make('Sales')
                    ->streamlined()
                    ->headers([
                    Header::make('Product'),
                    Header::make('Price'),
                    Header::make('Quantity'),
                    Header::make('Item Total')])
                    // ->renderHeader(false)
                    ->extraAttributes(['class'=>'custom-header-class'])
                    ...
                    ->schema([
                        Select::make('product_id')
                            ...
                            ->extraAttributes(['class' => 'text-red-500 border-blue-500'])  // Tailwind classes for TextInput
                        ...
                        // }),
                        TextInput::make('price')->label('Price')->placeholder('Price')->numeric()->disabled()->required(),
                        TextInput::make('item_total')->label('Item Total')->placeholder('Item Total')->numeric()->disabled()->required(),
                    ])
                    ->columns(4)
            ...
            TextInput::make('overall_price')->label('Total Price')->numeric()->disabled()->default(0)->reactive(),
            Grid::make(2)->schema([
